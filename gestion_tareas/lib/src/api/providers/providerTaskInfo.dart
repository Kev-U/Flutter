...
import '../../screens/taskInfo.dart';
import '../response.dart';

class TaskInfoProvider{

  Future<Respuesta> taskInfoProv(String id) async {
    ...
    final url = new Uri.https(baseURL, "vdev/tasks-challenge/tasks/"+id, _queryParameters);
    ...
    Map<String, dynamic> taskInfoMap = responseMap;
    //TaskInfo taskInfoList = TaskInfo.fromMap(taskInfoMap);


    return Respuesta(true, status, mensaje, data: responseMap);
